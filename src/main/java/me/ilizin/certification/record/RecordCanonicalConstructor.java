...
public class RecordCanonicalConstructor {
    ...
    public record Student(int id, String name, String address) implements Record.Person {
        ...
        /* Every record must have exactly one canonical constructor. If you don't provide it in your record explicitly,
           ...
           It is possible to do that by defining the canonical constructor explicitly.
           The order, the names, and the types must match with the record header.
           Initialization of component fields must be done explicitly.
