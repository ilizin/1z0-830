...
public class RecordCanonicalConstructor {
    ...
    public record Student(int id, String name, String address) {
        ...
        /* Every record must have exactly one canonical constructor, if you don't provide it in your record explicitly,
           the compiler will provide it for you. Unlike the default constructor of a regular class, the canonical
           ...
           match with the record header. Initialization of component fields must be done explicitly, and explicit calls
           to this(...) or super(...) are not allowed. */
        public Student(int id, String name, String address) { // protected is not allowed because of the record is public
