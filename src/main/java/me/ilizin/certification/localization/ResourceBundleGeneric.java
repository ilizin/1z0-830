...
public class ResourceBundleGeneric {
    ...
    public static void main(String[] args) {
        ...
        /* Resource bundles are hierarchical, meaning, a resource bundle always has a parent bundle unless the bundle
           ...
           The resource bundles names start with a common base name, such as helloapp, the remaining part of the
        ...
        try {
            System.out.println(Arrays.toString(rb.getStringArray("test")));
        } catch (Exception ex) {
            /* Not supported in PropertyResourceBundle */
