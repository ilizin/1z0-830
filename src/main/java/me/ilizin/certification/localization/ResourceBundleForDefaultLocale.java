...
public class ResourceBundleForDefaultLocale {
    ...
    /* The getBundle methods automatically read a properties file whose name matches with the name of the requested
       ...
       classpath and will load the entries into the helloapp_es_ES bundle. Since resource bundles are
       hierarchical, creation of a ResourceBundle triggers the creation of its parent bundle as well. Therefore, once
       helloapp_es_ES bundle is created, its parent bundle helloapp_es would also be created automatically
       Thus, it will look for helloapp_es.propertiesto create the helloapp_es bundle. Similarly, since the parent of
