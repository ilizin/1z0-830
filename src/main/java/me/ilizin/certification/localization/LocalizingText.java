...
public class LocalizingText {
    ...
    public static void main(String[] args) {
        ...
        /* The application contains two user facing strings - "What is your name?"and "Hi". To internationalize this
           application, these two strings must not be hardcoded. Instead, the code must use keys to look up the the
           actual phrases at run time. This is done as follows:
           If helloapp.properties is missing you will get a java.util.MissingResourceException.
