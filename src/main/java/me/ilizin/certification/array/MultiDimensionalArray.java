...
public class MultiDimensionalArray {
    ...
    public static void main(String[] args) {
        /* that Java doesn't have a multidimensional arrays. Java has a class of an array of ints is [I.
           Now, what if you want to have an array of objects of this class.
