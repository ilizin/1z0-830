...
public class MethodReference {
    ...
    /*  We are essentially telling the compiler to use the println method of System.out to generate the code for
        ...
        /* Identifying the method - The method name is written on the right side of :: in a method reference expression. For example, in
           ...
           left side of ::. It could be the name of a class (in case of a static method),
                Math::random - an instance of the class is not needed to invoke the method

           A variable that is already in scope (in case of an instance method),
                System.out::println, the target reference is identified by a static variable named out of class System. It
           refers to an instance of PrintStream. PrintStream has an instance method named println. Thus, the out variable
           can be used to invoke the println method.
           ...
           StringBuilder reference on which the reverse method will be invoked. This is, effectively, the same as the following:
           */
        ...
        /* The above code uses the same method reference but the isSpouse method is now static and it takes two
