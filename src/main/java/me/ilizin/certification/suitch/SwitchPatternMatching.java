...
public class SwitchPatternMatching {
    ...
    public static void main(String[] args) {
        ...
        /* The code tries to match the actual type of the object referred to by object with the reference types
           ...
           that case block. A regular switch statement need not be exhaustive but a switch statement that uses
           pattern matching is required to be exhaustive. */
        Object object = 10;
        ...
        System.out.println();
        /* It is possible to fall through to case null and default because no variables are expected to be available
           in these blocks. A pattern variable is required with each case label, except default and null */
        Object object3 = "Hello";
        switch (object3) {
            case Integer i : System.out.println(i); break; // fall through is NOT allowed here
            /* It's possible to redefine the same variable in a new block. */
            case String i : System.out.println(i.length()); // fall through is allowed here
            case null : System.out.println("null"); //fall through is allowed here
            default : System.out.println(object3);
        }
        ...
        that matches Number also matches Object. Thus, you cannot put case Object before case Number.
        If you do that, then case Number will become unreachable, therefore it's important to specify case labels in the
        ...
        object3 = new String();
        switch (object3) {
            case String str : System.out.println("String"); break; // Fall all through is not allowed here
            case CharSequence str : System.out.println("CharSequence"); // If put before String str won't compile
        ...
        System.out.println();
        switch (object3) {
            case Object str : System.out.println("Object"); break;
            // default : System.out.println(object3); // Object and default are not allowed together
        }
    }
}
