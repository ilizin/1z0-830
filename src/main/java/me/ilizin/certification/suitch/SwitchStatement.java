...
public class SwitchStatement {
    ...
    public static void main(String[] args) {
        ...
        switch (switchExpressionStr) {
            ...
            // case '1': System.out.println("1"); // Will not compile because the type is not assignable to a String
        ...
        switch (b) {
            default: System.out.println("b = " + b);
        }
        ...
        switch (b2 + 1) { // type of the selector expression here is now int due to numeric promotion
            case 11:  System.out.println("b2 + 1 = " + 11);
        }

        System.out.println();
        /* Java does not impose any particular order for the case and the default block, except in special situations
           involving null and pattern matching.
           It's common to have the default block at the end of a switch block, but you can have it at the beginning also.
           Case and default blocks order in combination with the use of the break statement determines the case blocks
           that get executed. */
        b2 = 10;
        switch (b2) {
            default: System.out.println("b2 is default");
            case 20: System.out.println("b2 is 20");
            case 30: System.out.println("b2 is 30");
        }
        b2 = 20;
        switch (b2) {
            default: System.out.println("-b2 is default");
        ...
        System.out.println();
        /* The break statement is optional, this is called "fall through" behavior, the control entered at the block
           labelled case 0, and executed all the other switch blocks */
        int aNumber = 0;
        switch (aNumber) {
            case 0:
                System.out.println("aNumber is 0");
            case 1:
                System.out.println("aNumber is 1");
            case 2:
                System.out.println("aNumber is 2");
            default:
                System.out.println("aNumber is default");
        }

        try {
            System.out.println();
            /* The code blocks associated with the switch labels are called switch blocks. In a switch statement written
               using the old syntax the switch block might be empty, it could contain zero or more "expression statements",
               it could contain zero or more code blocks, or it may throw an exception. */
            int i = 0;
            switch (i) {
                ...
                // case 6: 3; // Won't compile, that's not an expression statement
            }
        ...
        /* Prior to Java 21, the switch selector expression was restricted to only a few types: byte, short, char,
           int, their wrapper types, String (since Java 7), and enums
           In Java 21, the following types are allowed in addition to the previous ones:
           4. null as a case constant is allowed, prior to Java 21 if the selector expression returned null,
              a NullPointerException would be thrown.
           5. Any reference type (including all wrapper types). */
        String str = null;
        switch (str) {
            case null: System.out.println("str is null"); break;
            default: System.out.println("str is not null");

        }
        switch (str) {
            /* The above two lines can also be combined into one line, default can be only combined with case null */
            case null, default: System.out.println("str is null or default");
            // case "2", default: System.out.println("str is null or default"); // Not permitted
        }
